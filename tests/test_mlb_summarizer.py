...
def test_summarize_returns_none_when_no_hit_rates():
    summarizer, repo, _, _, _ = make_summarizer_with_data([])
...
def test_build_summary_serializes_relevant_injuries():
    ...
    summarizer, _, injury_service, signal_service, _ = make_summarizer_with_data(hit_rates, [relevant_injury])
...
def test_line_discrepancy_found():
    ...
    summarizer, _, _, _, _ = make_summarizer_with_data(hit_rates)
